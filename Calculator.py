...
##-----WINDOW AND LAYOUT---------------------------------##
layout: list = [
    [sg.Text('PyCalcGui', size=(50,1), justification='right', background_color="#272533", 
...
window: object = sg.Window('PyCalcGui', layout=layout, background_color="#272533", size=(700, 620), return_keyboard_events=True)
