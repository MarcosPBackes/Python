...
def HashGeneratorGUI():
    layout = [[sg.T('Password Hash Generator', size=(30,1), justification='center', font='Any 15')],
...
# ----------------------------- lógica (senha de desbloqueio, geradorSHA) -----------------------------
...
password = sg.popup_get_text('Senha', password_char='*')
if password == 'pygui':               
    HashGeneratorGUI()               
    exit(69)                         
